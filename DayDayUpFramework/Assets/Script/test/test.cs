...
public class test : MonoBehaviour
{
    ...
    void OnGUI()
    {
        if (GUILayout.Button("TEST"))
        {
            ...
            //UIWindowManager.Instance.PushWindow("ui/window", "redCanvas", delegate(UIWindow window)
            //{
            //    window.transform.SetParent(GameObject.Find("UIWindow").transform);
            //});

            //UIWindowManager.Instance.PushWindow("ui/window", "blueCanvas", delegate(UIWindow window)
            //{
            //    window.transform.SetParent(GameObject.Find("UIWindow").transform);
            //});            
